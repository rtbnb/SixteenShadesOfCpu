...
#
# Script generated by Vivado on Tue Nov 12 23:02:00 +0100 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_8 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot main_block xil_defaultlib.main_block xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim main_block -key {Behavioral:completeMMU_Sim:Functional:main_block} -tclbatch cmd.tcl -protoinst "protoinst_files/main_block.protoinst" -log simulate.log
}
