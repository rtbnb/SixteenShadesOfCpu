...
#
# Script generated by Vivado on Fri Nov 08 16:20:26 +0100 2024
...
simulate()
{
  xsim main_block -key {Behavioral:completeSystemSim:Functional:main_block} -tclbatch cmd.tcl -protoinst "protoinst_files/main_block.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/AMD/Vivado/2024.1/data/xsim"
  fi
