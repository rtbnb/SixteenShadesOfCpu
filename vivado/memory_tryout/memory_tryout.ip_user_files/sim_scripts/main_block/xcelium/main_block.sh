...
#
# Script generated by Vivado on Wed Nov 06 12:37:47 +0100 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : main_block.sh
...
#
# Usage        : main_block.sh
#                main_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                main_block.sh [-reset_run]
#                main_block.sh [-reset_log]
#                main_block.sh [-help]
#
...
#                script (type 'main_block.sh -help' for more information).
#
...
design_libs_elab="-libname xil_defaultlib -libname blk_mem_gen_v8_4_8 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib blk_mem_gen_v8_4_8)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "main_block.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./main_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../memory_tryout.gen/sources_1/bd/main_block/ipshared/3242" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../../memory_tryout.gen/sources_1/bd/main_block/ipshared/3242" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.main_block xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.main_block -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log main_block_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./main_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: main_block.sh [-help]\n\
Usage: main_block.sh [-step]\n\
Usage: main_block.sh [-lib_map_path]\n\
Usage: main_block.sh [-reset_run]\n\
Usage: main_block.sh [-reset_log]\n\
Usage: main_block.sh [-keep_index]\n\
Usage: main_block.sh [-noclean_files]\n\n\
