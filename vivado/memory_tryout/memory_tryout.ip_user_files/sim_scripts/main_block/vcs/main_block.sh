...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../memory_tryout.gen/sources_1/bd/main_block/ipshared/3242" \
  ...
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k +incdir+"../../../../memory_tryout.gen/sources_1/bd/main_block/ipshared/3242" \
