...
HD_PWD='C:/Entwicklung/SixteenShadesOfCpu/vivado/memory_tryout/memory_tryout.runs/main_block_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_block_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_block_blk_mem_gen_0_0.tcl
