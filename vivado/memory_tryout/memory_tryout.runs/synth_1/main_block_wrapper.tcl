...
read_vhdl -library xil_defaultlib c:/Entwicklung/SixteenShadesOfCpu/vivado/memory_tryout/memory_tryout.gen/sources_1/bd/main_block/hdl/main_block_wrapper.vhd
...
synth_design -top main_block_wrapper -part xc7a35ticsg324-1L
...
write_checkpoint -force -noxdef main_block_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file main_block_wrapper_utilization_synth.rpt -pb main_block_wrapper_utilization_synth.pb"  } 
