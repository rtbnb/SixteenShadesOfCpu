...
HD_PWD='O:/Entwicklung/SixteenShadesOfCpu/vivado/memory_tryout/memory_tryout.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_block_wrapper.tcl
