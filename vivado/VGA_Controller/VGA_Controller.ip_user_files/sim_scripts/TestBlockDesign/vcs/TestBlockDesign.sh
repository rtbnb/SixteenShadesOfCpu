...
design_libs=(xpm xil_defaultlib blk_mem_gen_v8_4_8)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.TestBlockDesign xil_defaultlib.glbl -o TestBlockDesign_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./TestBlockDesign_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key TestBlockDesign_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc TestBlockDesign_simv.daidir vcs_lib c.obj)
