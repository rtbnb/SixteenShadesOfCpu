...
#
# Script generated by Vivado on Thu Nov 21 21:31:49 +0100 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : TestBlockDesign.sh
...
#
# Usage        : TestBlockDesign.sh
#                TestBlockDesign.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TestBlockDesign.sh [-reset_run]
#                TestBlockDesign.sh [-reset_log]
#                TestBlockDesign.sh [-help]
#
...
# script info
echo -e "TestBlockDesign.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TestBlockDesign.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_8 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TestBlockDesign xil_defaultlib.TestBlockDesign xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TestBlockDesign -key {Behavioral:sim_1:Functional:TestBlockDesign} -tclbatch cmd.tcl -protoinst "protoinst_files/TestBlockDesign.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/programme/Xilinx/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TestBlockDesign.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./TestBlockDesign.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: TestBlockDesign.sh [-help]\n\
Usage: TestBlockDesign.sh [-step]\n\
Usage: TestBlockDesign.sh [-lib_map_path]\n\
Usage: TestBlockDesign.sh [-reset_run]\n\
Usage: TestBlockDesign.sh [-reset_log]\n\
Usage: TestBlockDesign.sh [-keep_index]\n\
Usage: TestBlockDesign.sh [-noclean_files]\n\n\
