...
#                script (type 'TestBlockDesign.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname blk_mem_gen_v8_4_8 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib blk_mem_gen_v8_4_8)
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.TestBlockDesign xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.TestBlockDesign -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log TestBlockDesign_sc.so .tmp_log xcelium_lib waves.shm c.obj)
