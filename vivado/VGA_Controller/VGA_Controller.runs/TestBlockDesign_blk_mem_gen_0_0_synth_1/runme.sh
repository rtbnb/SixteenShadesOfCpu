...
HD_PWD='D:/Programmieren/Projekte/FPGA_CPU/SixteenShadesOfCpu/vivado/VGA_Controller/VGA_Controller.runs/TestBlockDesign_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestBlockDesign_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestBlockDesign_blk_mem_gen_0_0.tcl
