...
synth_design -top TestBlockDesign_VGA_Controller_0_0 -part xc7a35ticsg324-1L -incremental_mode off -mode out_of_context
OPTRACE "synth_design" END { }
if { [get_msg_config -count -severity {CRITICAL WARNING}] > 0 } {
 send_msg_id runtcl-6 info "Synthesis results are not added to the cache due to CRITICAL_WARNING"
}

rename_ref -prefix_all TestBlockDesign_VGA_Controller_0_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef TestBlockDesign_VGA_Controller_0_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file TestBlockDesign_VGA_Controller_0_0_utilization_synth.rpt -pb TestBlockDesign_VGA_Controller_0_0_utilization_synth.pb"  } 
...
OPTRACE "TestBlockDesign_VGA_Controller_0_0_synth_1" END { }
