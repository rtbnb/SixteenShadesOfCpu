...
HD_PWD='D:/FPGA_CPU/vivado/VGA_Controller/VGA_Controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestBlockDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestBlockDesign_wrapper.tcl -notrace
