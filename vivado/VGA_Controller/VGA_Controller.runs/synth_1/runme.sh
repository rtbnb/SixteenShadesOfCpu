...
HD_PWD='D:/FPGA_CPU/vivado/VGA_Controller/VGA_Controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestBlockDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestBlockDesign_wrapper.tcl
