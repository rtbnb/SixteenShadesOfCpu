...
#
# Script generated by Vivado on Tue Nov 19 13:16:38 +0100 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Code/VHDL/SixteenShadesOfCpu/vivado/ALU_Testing/ALU_Testing.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
