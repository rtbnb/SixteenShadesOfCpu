...
architecture STRUCTURE of main_block is
  ...
  signal clockcontroller_0_debugEnableOut : STD_LOGIC;
  ...
  signal debugEnableIn_1 : STD_LOGIC;
  ...
  attribute X_INTERFACE_PARAMETER of debugClk : signal is "XIL_INTERFACENAME CLK.DEBUGCLK, CLK_DOMAIN main_block_clockcontroller_0_0_debugClk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
  attribute X_INTERFACE_INFO of vgaClk : signal is "xilinx.com:signal:clock:1.0 CLK.VGACLK CLK";
  attribute X_INTERFACE_PARAMETER of vgaClk : signal is "XIL_INTERFACENAME CLK.VGACLK, CLK_DOMAIN main_block_clockcontroller_0_0_vgaClk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
begin
  btn00_1 <= btn00;
  btn01_1 <= btn01;
  btn02_1 <= btn02;
...
clockcontroller_0: component main_block_clockcontroller_0_0
     port map (
      ...
      debugClk => clockcontroller_0_debugClk,
      debugEnableIn => debugEnableIn_1,
      debugEnableOut => clockcontroller_0_debugEnableOut,
...
mmu_1: component main_block_mmu_1_0
     port map (
      ...
      debugEnable => clockcontroller_0_debugEnableOut,
