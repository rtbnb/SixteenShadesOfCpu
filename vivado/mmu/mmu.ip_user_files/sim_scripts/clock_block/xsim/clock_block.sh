...
#
# Script generated by Vivado on Sat Nov 23 15:06:58 +0100 2024
...
#
# Usage        : clock_block.sh
#                clock_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clock_block.sh [-reset_run]
#                clock_block.sh [-reset_log]
#                clock_block.sh [-help]
#
...
# script info
echo -e "clock_block.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clock_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clock_block xil_defaultlib.clock_block xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clock_block -key {Behavioral:cc_sim:Functional:clock_block} -tclbatch cmd.tcl -protoinst "protoinst_files/clock_block.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clock_block.wdb xsim.dir libdpi.so)
...
Usage: clock_block.sh [-step]\n\
Usage: clock_block.sh [-lib_map_path]\n\
Usage: clock_block.sh [-reset_run]\n\
Usage: clock_block.sh [-reset_log]\n\
Usage: clock_block.sh [-keep_index]\n\
