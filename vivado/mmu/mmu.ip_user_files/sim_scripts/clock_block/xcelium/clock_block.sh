...
#                script (type 'clock_block.sh -help' for more information).
#
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../mmu.gen/sources_1/bd/clock_block/ipshared/3242" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../mmu.gen/sources_1/bd/clock_block/ipshared/3242" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clock_block xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clock_block -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clock_block_sc.so .tmp_log xcelium_lib waves.shm c.obj)
