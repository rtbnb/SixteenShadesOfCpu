...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../mmu.gen/sources_1/bd/clock_block/ipshared/3242" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../mmu.gen/sources_1/bd/clock_block/ipshared/3242" \
...
reset_run()
{
  files_to_remove=(ucli.key clock_block_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clock_block_simv.daidir vcs_lib c.obj)
