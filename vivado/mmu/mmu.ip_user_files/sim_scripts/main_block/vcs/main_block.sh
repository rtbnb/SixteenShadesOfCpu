...
#
# Script generated by Vivado on Wed Nov 20 09:34:20 +0100 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../mmu.gen/sources_1/bd/main_block/ipshared/3242" \
  ...
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k +incdir+"../../../../mmu.gen/sources_1/bd/main_block/ipshared/3242" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../mmu.gen/sources_1/bd/main_block/ipshared/3242" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.main_block xil_defaultlib.glbl -o main_block_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./main_block_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key main_block_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc main_block_simv.daidir vcs_lib c.obj)
