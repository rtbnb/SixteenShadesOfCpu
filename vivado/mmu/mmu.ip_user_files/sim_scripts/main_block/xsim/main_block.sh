...
#
# Script generated by Vivado on Thu Nov 28 16:00:30 +0100 2024
...
simulate()
{
  xsim main_block -key {Behavioral:tim_sim:Functional:main_block} -tclbatch cmd.tcl -protoinst "protoinst_files/main_block.protoinst" -log simulate.log
}
