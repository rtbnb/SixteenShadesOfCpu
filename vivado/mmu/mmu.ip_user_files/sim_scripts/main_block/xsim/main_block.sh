...
#
# Script generated by Vivado on Thu Nov 28 22:20:17 +0100 2024
...
simulate()
{
  xsim main_block -key {Behavioral:btn_sim:Functional:main_block} -tclbatch cmd.tcl -protoinst "protoinst_files/main_block.protoinst" -log simulate.log
}
