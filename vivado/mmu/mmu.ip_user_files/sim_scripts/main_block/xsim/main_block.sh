...
#
# Script generated by Vivado on Mon Nov 18 02:30:09 +0100 2024
...
simulate()
{
  xsim main_block -key {Behavioral:sim_1:Functional:main_block} -tclbatch cmd.tcl -protoinst "protoinst_files/main_block.protoinst" -log simulate.log
}
