...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../mmu.gen/sources_1/bd/main_block/ipshared/3242" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../../mmu.gen/sources_1/bd/main_block/ipshared/3242" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../mmu.gen/sources_1/bd/main_block/ipshared/3242" \
