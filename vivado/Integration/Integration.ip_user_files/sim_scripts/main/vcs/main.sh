...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../Integration.gen/sources_1/bd/main/ipshared/3242" \
  ...
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k +incdir+"../../../../Integration.gen/sources_1/bd/main/ipshared/3242" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../Integration.gen/sources_1/bd/main/ipshared/3242" \
...
reset_run()
{
  files_to_remove=(ucli.key main_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc main_simv.daidir vcs_lib c.obj)
