...
#
# Script generated by Vivado on Sat Nov 23 17:50:08 +0100 2024
...
#
# Usage        : main.sh
#                main.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                main.sh [-reset_run]
#                main.sh [-reset_log]
#                main.sh [-help]
#
...
#                script (type 'main.sh -help' for more information).
#
...
# script info
echo -e "main.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./main.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../Integration.gen/sources_1/bd/main/ipshared/3242" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../../Integration.gen/sources_1/bd/main/ipshared/3242" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Integration.gen/sources_1/bd/main/ipshared/3242" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.main xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.main -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log main_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: main.sh [-reset_log]\n\
Usage: main.sh [-keep_index]\n\
