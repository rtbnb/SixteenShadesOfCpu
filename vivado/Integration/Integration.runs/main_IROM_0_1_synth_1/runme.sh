...
HD_PWD='D:/FPGA_CPU/vivado/Integration/Integration.runs/main_IROM_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_IROM_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_IROM_0_1.tcl
