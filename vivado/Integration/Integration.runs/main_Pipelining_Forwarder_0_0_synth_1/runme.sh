...
HD_PWD='D:/FPGA_CPU/vivado/Integration/Integration.runs/main_Pipelining_Forwarder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_Pipelining_Forwarder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_Pipelining_Forwarder_0_0.tcl
