...
HD_PWD='D:/FPGA_CPU/vivado/Integration/Integration.runs/main_CU_JumpController_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_CU_JumpController_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_CU_JumpController_0_0.tcl
