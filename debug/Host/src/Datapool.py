class Datapool:
    def __init__(self):
        self.data = {
            ...
            b"\x15": {'data_1_high': b'\x00', 'data_1_low': b'\x00', 'Name': "pipeline_rf_read_buf"},
            b"\x16": {'data_1_high': b'\x00', 'data_1_low': b'\x00', 'Name': "pipeline_jmp_condl_rel_dests_cond_out"},
            b"\x17": {'data_1_high': b'\x00', 'data_1_low': b'\x00', 'Name': "pipeline_taking_data"},
            b"\x18": {'data_1_high': b'\x00', 'data_1_low': b'\x00', 'Name': "pipeline_immediate_out"},
            b"\x19": {'data_1_high': b'\x00', 'data_1_low': b'\x00', 'Name': "pipeline_write_address_out"},
            b"\x1A": {'data_1_high': b'\x00', 'data_1_low': b'\x00', 'Name': "pipeline_whb_wlb_out"},
            ...
            b"\x1D": {'data_1_high': b'\x00', 'data_1_low': b'\x00', 'Name': "pipeline_is_alu_ram_gpu_op_out"},
            ...
            b"\x32": {'data_1_high': b'\x00', 'data_1_low': b'\x00', 'data_2_high': b'\x00', 'data_2_low': b'\x00', 'Name': "read_iram"},
            b"\x33": {'Name': "write_vram"},
            b"\x34": {'Name': "write_mmio"},
            b"\x35": {'data_1_high': b'\x00', 'data_1_low': b'\x00', 'data_2_high': b'\x00', 'data_2_low': b'\x00', 'Name': "read_vram"},
            b"\x36": {'data_1_high': b'\x00', 'data_1_low': b'\x00', 'data_2_high': b'\x00', 'data_2_low': b'\x00', 'Name': "read_gram"},
            b"\x37": {'data_1_high': b'\x00', 'data_1_low': b'\x00', 'data_2_high': b'\x00', 'data_2_low': b'\x00', 'Name': "read_mmio"},
