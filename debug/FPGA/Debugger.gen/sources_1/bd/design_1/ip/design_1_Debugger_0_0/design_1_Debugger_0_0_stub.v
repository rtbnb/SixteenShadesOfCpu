...
module design_1_Debugger_0_0(clk, b1, rx_data, rx_data_valid, led, tx_data, 
  tx_data_valid, tx_data_sended)
/* synthesis syn_black_box black_box_pad_pin="b1,rx_data[7:0],led[3:0],tx_data[7:0],tx_data_valid,tx_data_sended" */
/* synthesis syn_force_seq_prim="clk" */
/* synthesis syn_force_seq_prim="rx_data_valid" */;
  input clk /* synthesis syn_isclock = 1 */;
  input b1;
  input [7:0]rx_data;
  input rx_data_valid /* synthesis syn_isclock = 1 */;
  output [3:0]led;
  output [7:0]tx_data;
