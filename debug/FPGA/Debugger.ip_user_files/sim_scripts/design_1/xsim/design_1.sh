...
#
# Script generated by Vivado on Sun Nov 17 18:55:50 +0100 2024
...
simulate()
{
  xsim design_1 -key {Behavioral:Debugger:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
