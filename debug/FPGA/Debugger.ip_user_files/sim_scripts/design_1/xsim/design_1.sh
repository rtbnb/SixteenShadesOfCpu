...
#
# Script generated by Vivado on Sat Nov 16 22:58:18 +0100 2024
...
simulate()
{
  xsim design_1 -key {Behavioral:Debugger:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/design_2.protoinst" -log simulate.log
}
